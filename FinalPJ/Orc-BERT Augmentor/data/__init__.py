...
def build_quickdraw_memmap_dsets(args, logger, mask_prob=None):
    dset_kwargs = {
        ...
        'mask_prob':args.mask_prob if mask_prob is None else mask_prob,
        'limit':args.limit,
...
def build_loaders(args, logger, shuffle=True, mask_prob=None):
    loader_kwargs = {
    ...
    if args.dataset == 'vg':
        ...
        vocab, train_dset, val_dset, iter_per_epoch = build_quickdraw_memmap_dsets(args, logger, mask_prob)
