...
def parse_opt():
    ...
    parser.add_argument('--input_dic', type=str, default='data/noc_coco/dic_coco.json',
    ...
    parser.add_argument('--image_path', type=str, default='/tmp/pycharm_project_904/cocoapi/images',
                        help='path to the h5file containing the image data')
    ...
    parser.add_argument('--val_every_epoch', type=int, default=3,
                    help='how many images to use when periodically evaluating the validation loss? (-1 = all)')
    parser.add_argument('--checkpoint_path', type=str, default='/tmp/pycharm_project_904/NBT/save2',
