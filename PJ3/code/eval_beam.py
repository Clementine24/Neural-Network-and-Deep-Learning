...
if __name__ == '__main__':
    ...
    # print('The first 100 data of itow:', list(opt.itow.values)[:100])
    # print('The first 100 data of itod:', list(opt.itod.values)[:100])
    # print('The first 100 data of ltow:', list(opt.ltow.values)[:100])
    # print('The first 100 data of itoc:', list(opt.itoc.values)[:100])
