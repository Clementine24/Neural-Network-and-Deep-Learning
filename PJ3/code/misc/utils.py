...
def noc_eval(pred, model_id, split, opt):
    ...
    # gt_template_novel = '/tmp/pycharm_project_941/data/annotations/' + 'captions_split_set_%s_val_%s_novel2014.json'
    # gt_template_train = '/tmp/pycharm_project_941/data/annotations/' + 'captions_split_set_%s_val_%s_train2014.json'
    gt_template_novel = '/tmp/pycharm_project_904/cocoapi/annotations/annotations_DCC_clean/' + 'captions_split_set_%s_val_%s_novel2014.json'
