...
nlp = StanfordCoreNLP(
  os.path.join(os.path.dirname(os.path.realpath(__file__)),
      '/tmp/pycharm_project_904/stanford-corenlp-full-2017-06-09'), memory='8g')
...
def main(params):
  ...
  if params['split'] == 'robust':
    ...
    #   split_map['test'][img] = 1
    file_dir = "/tmp/pycharm_project_904/cocoapi/annotations/annotations_DCC_clean"
    ...
    print('One of the file name:',f)
    print('The num of train set is:',len(split_map['train']),
          'The num of val set is:',len(split_map['val']),
          'The num of test set is:',len(split_map['test']))
...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='/tmp/pycharm_project_904/NBT/data/coco/dataset_coco.json', help='input json file to process into hdf5')
  parser.add_argument('--split', default='noc', help='different split for different task.')

  parser.add_argument('--output_dic_json', default='/tmp/pycharm_project_904/NBT/data/noc_coco/dic_coco_noc_only.json', help='output json file')
  parser.add_argument('--output_cap_json', default='/tmp/pycharm_project_904/NBT/data/noc_coco/cap_coco_noc_only.json', help='output json file')
