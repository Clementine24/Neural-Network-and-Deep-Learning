...
np.save(save_path+'vgg_train_ac.npy', vgg_train_ac)
np.save(save_path+'vgg_val_ac.npy', vgg_val_ac)
np.save(save_path+'vgg_loss.npy', vgg_loss)
np.save(save_path+'vgg_grad.npy', vgg_grad)
np.save(save_path+'vgg_weight.npy', vgg_weight)
...
np.save(save_path+'vgg_bn_train_ac.npy', vgg_bn_train_ac)
np.save(save_path+'vgg_bn_val_ac.npy', vgg_bn_val_ac)
np.save(save_path+'vgg_bn_loss.npy', vgg_bn_loss)
np.save(save_path+'vgg_bn_grad.npy', vgg_bn_grad)
np.save(save_path+'vgg_bn_weight.npy', vgg_bn_weight)
