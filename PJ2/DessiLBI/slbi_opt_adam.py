...
# @Time : 2022/5/2 13:07
# @Author : fan
# @File:slbi_opt_adam.py
# @Software: PyCharm

"""
Combine DessiLBI with Adam
"""
...
class SLBI(Optimizer):
    ...
    def __init__(self, params, lr=required, kappa=1, mu=100, betas=(0.9,0.999), eps=1e-8, weight_decay=0, momentum=0.9, dampening=0):
        defaults = dict(lr=lr, kappa=kappa, mu=mu, betas=betas, eps=eps, weight_decay=weight_decay, momentum=momentum, dampening=dampening)
        print('*******************************************')
        for key in defaults:
